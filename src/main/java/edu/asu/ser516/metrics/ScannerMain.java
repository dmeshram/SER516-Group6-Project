...
public class ScannerMain {
    public static void main(String[] args) {
        ...
        try {
            ...
            String output = formatOutput(results, format);
    ...
    private static String formatOutput(Map<String, int[]> results, String format) {
        StringBuilder sb = new StringBuilder();
        switch (format) {
            case "csv":
                sb.append("Class,Fan-Out,Fan-In\n");
                results.forEach((cls, metrics) -> 
            ...
            default:
                ...
                results.forEach((cls, metrics) -> 
                    sb.append(String.format("%-50s %-10d %-10d\n", cls, metrics[0], metrics[1])));
                break;
        }
        return sb.toString();
    }
